...
class DetectRFID(ACS):
    """Пакеты XXX

    -описание-.
    """
    type_name = 'ACS'
    subtype_name = 'DetectRFID'


class TurnstileControl(ACS):
    """Пакеты XXX

    -описание-.
    """
    type_name = 'ACS'
    subtype_name = 'TurnstileControl'


class RFIDListControl(ACS):
    """Пакеты XXX

    -описание-.
    """
    type_name = 'ACS'
    subtype_name = 'RFIDListControl'
...
packet_type['ACS'] = {0xFF: {'name': Packet.type_name, 'class': Packet},  # ACS
                      0x00: {'name': Packet.type_name, 'class': Packet},  # DetectRFID
